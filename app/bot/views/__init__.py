from bot.views.switcher import handlers
from bot.views.account.info import handlers
from bot.views.account.settings import handlers
from bot.views.account.chat_list import handlers
from bot.views.account.create import handlers
from bot.views.main import handlers
from bot.views.distribution.settings import handlers
from bot.views.distribution.start import handlers

from bot.views.distribution.settings import processors
